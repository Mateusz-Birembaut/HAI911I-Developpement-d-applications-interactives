...
Window::Window()
{
    ...
    QAction * actionLoad3Dmesh = new QAction("Load 3D mesh", this);
    ...
    menuFile->addAction(actionLoad3Dmesh);


    connect(actionLoad3Dimage, SIGNAL(triggered()), this, SLOT(open3DImage()));
    connect(actionLoad3Dmesh, SIGNAL(triggered()), this, SLOT(open3DMesh()));
...
void Window::open3DMesh(){

    QString selectedFilter, openFileNameLabel;
    QString fileFilter = "Known Filetypes (*.off)";

    QString fileName = QFileDialog::getOpenFileName(this,
                                                    tr("Select an input 3D mesh"),
                                                    openFileNameLabel,
                                                    fileFilter,
                                                    &selectedFilter);
